  ...
  return (
    <div className="min-h-screen relative">
      ...
      <footer className="border-t border-white/[0.04] py-6 mt-8">
        <div className="flex items-center justify-center gap-1.5 text-xs text-muted/30">
          <span>Created by Fazal Hassan</span>
          <span className="text-muted/15">|</span>
          <a
            href="https://www.linkedin.com/in/fazal-hassan/"
            target="_blank"
          ...
          <a
            href="https://github.com/HassanFazal97"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted/40 hover:text-accent transition-colors"
          >
